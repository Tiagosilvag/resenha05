/**
 * Cliente HTTP da API. Sempre chama /api/* (mesma origem: proxy do Vite em dev,
 * nginx em produção). Guarda os tokens no localStorage e renova o access token
 * automaticamente com o refresh quando expira.
 */
const BASE = '/api';
