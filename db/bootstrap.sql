...
-- ============================ 0007_organizacao_codigo.sql ============================
\echo '== 0007_organizacao_codigo.sql =='
BEGIN;
-- =============================================================================
...
-- ============================ 0009_fases_torneio.sql ============================
\echo '== 0009_fases_torneio.sql =='
BEGIN;
-- =============================================================================
...
INSERT INTO _migrations (nome) VALUES ('0009_fases_torneio.sql') ON CONFLICT DO NOTHING;
COMMIT;
